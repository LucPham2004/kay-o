        ...
        <div className={`relative max-h-[8vh] min-h-[8vh] min-w-full flex items-center justify-between px-4 border-b
            ...
            <div className="relative flex items-center gap-2">
                ...
                {auth.isAuthenticated ? (
                    <>
                        <button
                            className={`rounded-full text-xl p-1
                        ...
                        {showMenuDropdown && (
                            <div className={`absolute top-10 right-0 mt-2 p-2 w-max min-w-60 rounded-2xl shadow-lg z-50 
                    ...
                    <div className="flex items-center gap-4">
                        <button
                            ...
                            ${isDarkMode ? ' hover:bg-[#454647] text-yellow-400' : 'text-yellow-400 hover:bg-gray-200'}`}>
                            <div className={`w-10 h-4 flex items-center bg-gray-400 rounded-full px-[1px] 
                                transition-all duration-300
                        ...
                        <button
                            ...
                            className={`px-4 pt-2 pb-2.5 rounded-full font-medium text-sm
                                ${isDarkMode 
                        ...
                        <button
                            ...
                            className={`px-4 pt-2 pb-2.5 rounded-full font-medium text-sm border border-gray-400
                                ${isDarkMode 
                                    ? 'bg-[#232425] hover:bg-[#363739] text-white' 
